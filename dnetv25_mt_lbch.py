...
class SBA(nn.Module):
    ...
    def __init__(self, input_dim=64):
        ...
        self.conv = BasicConv2d(2 * self.input_dim, self.input_dim, 1)
...
class Stem(nn.Module):
    def __init__(self,in_c = 3, min_c = 32, out_c = 64,embed_dims=[64,128,320,512]):
        ...
        self.rb1 = nn.Sequential(RB1(embed_dims[0], embed_dims[1]),RB(embed_dims[1], embed_dims[1]))
        self.rb2 = nn.Sequential(RB1(embed_dims[1], embed_dims[2]),RB(embed_dims[2], embed_dims[2]))
        self.rb3 = nn.Sequential(RB1(embed_dims[2], embed_dims[3]),RB(embed_dims[3], embed_dims[3]))
    ...
    def forward(self,x):
        ...
        x1 = x
        #print(x1.shape)
        x2 = self.rb1(x1) #44,128
        #print(x2.shape)
        x3 = self.rb2(x2) #22,256
        #print(x3.shape)
        x4 = self.rb3(x3) #11,512
        #print(x4.shape)
